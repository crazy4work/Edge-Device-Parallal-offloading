...
class PartitionBasedClustering:
    ...
    def partition_based_clustering(self, time, delta_time, max_speed):
        ...
        for node in list(set(self.dataset)-set(self.clusters)):
            ...
            for cluster in self.clusters:
                ...
                for t in range(delta_time):
                    x1, y1, z1=node.get_curr_pos(t=time+t, max_speed=max_speed)
                    x2, y2, z2=cluster.get_curr_pos(t=time+t, max_speed=max_speed)
...
if __name__ == "__main__":
    ...
    find_path(candidate_sn, candidate_relay, relay_node, Tavs)
