...
class Vehicle():
    ...
    def __init__(self, max_speed):
        ...
        self.computation_cycles_per_sec = 1000000000000  # 1 GHz
        ...
        self.__absolute_speed, self.__cos_x, self.__cos_y, self.__cos_z = self.generate_random_speed_vector(40, 0, 0, 0, max_speed)
        self.speed_vec = (self.__absolute_speed, self.__cos_x, self.__cos_y, self.__cos_z)
        #task=(size, cpu cycles per bit, max_latecy tolerable)
    ...
    def generate_random_speed_vector(self, initial_speed, initial_x, initial_y, initial_z, max_speed):
    ...
    def get_curr_pos(self, t=0, max_speed=60):
...
def create_vehicles(num_vehicles, max_speed):
...
def main(num_vehicles, max_speed):
    
    #num_vehicles = int(input("Enter the number of vehicles: "))
    #num_vehicles=50
    vehicles= create_vehicles(num_vehicles, max_speed)
